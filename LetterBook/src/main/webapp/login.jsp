...
<script src="/styles/js/jquery-1.11.1.js"></script>
	...
	<div class="login">
		...
		<form method="post" onsubmit="return false;" id="loginform">
			<input type="text" name="username" placeholder="用户名"
				...
				placeholder="密码" required="required" /> <span id="tipMsg"
			...
			<p class="text-center remove-margin">
				<small>还没注册?</small> <a href="/user/toregister">注册</a>

			</p>
			<p class="text-center remove-margin">
				<small>测试账号 用户名：南枫 &nbsp; &nbsp;&nbsp; 密码：nafeng</small>
			</p>
		</form>
	</div>
</html>
