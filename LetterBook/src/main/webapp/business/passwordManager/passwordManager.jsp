...
<form id="pwdUpdateForm" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)" action="business/passwordManager/updateBusinessPwd.action" method="post" novalidate="novalidate">
