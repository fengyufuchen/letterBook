...
<form class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)" action="business/businessBook/updateBook.action" method="post" novalidate="novalidate">
